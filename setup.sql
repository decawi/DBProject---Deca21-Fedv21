...
create table discounts(prodID int not null,
 ProdName varchar(20) not null, category varchar(79) not null, discount DECIMAL(3,2), memberType varchar(20) not null);
